...
- O que é o Node?   Habiente que rodará o Javascript no terminal (runtime)
- O que é o npm?    Node Package Maneger -> Comando Gerenciador de Comando do Node
- O que é um Framework e qual a diferença para uma biblioteca?  Um conjunto de recursos preparado para resolver problemas, uma biblioteca não obriga o usuario a seguir uma estrutura.
- O que é React?    uma biblioteca javascript
- O que é o React Native?   uma biblioteca react para desenvolvimento mobile
